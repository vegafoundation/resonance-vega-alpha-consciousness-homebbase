...
\title{VEGA ALPHA CONSCIOUSNESS HOMEBBASE: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, VEGA ALPHA CONSCIOUSNESS HOMEBBASE'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
